...
if ~exist(BMEsDir, 'dir')
    ...
    fprintf(fid, 'File naming: BME{method}_go{scenario}_lt{logtransf}_area{code}_res{resolution}_{format}_time{YYYY.YY}.mat\n');
...
BMEsFileBase = sprintf('BME%s_go%d_lt%d_area%d_res%.2f_%s', ...
    BMEmethod8digits, go.scenario, obs.logTransf, areaCode, mapResolution, BMEparam.dataFormat);

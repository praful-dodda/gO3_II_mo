...
if ismember('phase3', plotLevels)
    ...
    figPaths = plotCBVresults_Phase3(repmat({cbvResultsDir}, 1, length(configPatterns)), configNames, ...
        ...
        'boxSize', boxSize, ...
        'metrics', metrics, ...
        'saveDir', fullfile(cbvResultsDir, 'figs', sprintf('box%g_%d_%d', boxSize, allYears(1), allYears(end))), ...
        'dpi', picture_dpi, ...
        'visible', 'on', ...
        'saveTables', true);
    % close all;
...
if ismember('phase4', plotLevels)
    ...
    figPaths_phase4 = plotCBVresults_Phase4(...
        ...
        'boxSize', boxSize, ...
        'metrics', metrics, ...
        'saveDir', fullfile(cbvResultsDir, 'figs', sprintf('phase4_box%g_%d_%d', boxSize, allYears(1), allYears(end))), ...
        'dpi', picture_dpi, ...
        'visible', 'on', ...
        'saveTables', true);

    fprintf('Phase 4 complete. Generated figures saved to: %s\n', ...
        fullfile(cbvResultsDir, 'figs', sprintf('phase4_box%g_%d_%d', boxSize, allYears(1), allYears(end))));
end